...
urlpatterns = [
    ...
    path("documents/contracts/<int:contract_id>/edit/", contract_views.contract_edit, name="contract_edit"),
    ...
    path("documents/contracts/export/contract/", contract_views.export_contract_list, name="export_contract_list"),
